...
/**
 * REST controller for managing {@link com.shop.adm.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    public ResponseEntity<Category> updateCategory(@RequestParam String jsonCategory, MultipartFile files) throws URISyntaxException, IOException {
        ...
        Category result = categoryService.updateCategory(category, files);
    ...
    public ResponseEntity<Void> deleteCategory(@PathVariable Long id) {
        ...
        Optional<Category> categoryExist = categoryService.getCategory(id);
